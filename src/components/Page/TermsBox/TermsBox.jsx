                    ...
                    <div className="content min-h-[681px] w-full py-[43px] px-[30px] md:px-[58px] flex gap-[43px] flex-col justify-start items-start">
                        ...
                        <div className="box flex-col justify-start items-start">
                            ...
                            <p>
                                ...
                                *إن منصات المشاهير تلتزم بالتعامل مع معلوماتك الشخصية وعناوين الاتصال بك بسريّة وفقاً لأحكام سياسة الخصوصية وسرية المعلومات المعمول بها لدى منصات المشاهير.
                        ...
                        <div className="box flex-col justify-start items-start">
                            ...
                            <p>
                                ...
                                * تخضع سرية معلومات المتاجر والتجار لقواعد “سياسة الخصوصية وسرية المعلومات” الخاصة بمنصات المشاهير.
                        ...
                        <div className="box flex-col justify-start items-start">
                            ...
                            <p>
                                * يتعهّد التاجر بالالتزام بكافة القوانين والأنظمة المعمول بها داخل المملكة العربية السعودية حيال منتجاته أو أثناء استخدامه لمنصات المشاهير، وكذا القوانين والشروط والأحكام المعمول بها والمُنظِّمة لاستخدام فضاء الإنترنت واتفاقية الاستخدام وسياسة الخصوصية وسرية المعلومات المعمول بها لدى منصات المشاهير.
                                * يتعهّد المشهور بالالتزام بكافة القوانين والأنظمة المعمول بها داخل المملكة العربية السعودية حيال إعلاناته أو أثناء استخدامه لمنصات المشاهير، وكذا القوانين والشروط والأحكام المعمول بها والمُنظِّمة لاستخدام فضاء الإنترنت واتفاقية الاستخدام وسياسة الخصوصية وسرية المعلومات المعمول بها لدى منصات المشاهير.
