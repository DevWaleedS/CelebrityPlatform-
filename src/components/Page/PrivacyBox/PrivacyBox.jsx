                ...
                <div className="container h-full flex justify-center flex-col gap-[28px] items-center mt-[48px]">
                    ...
                    <div className="content min-h-[357px] w-full py-[43px] px-[30px] md:px-[58px] flex gap-[43px] flex-col justify-start items-start">
                        ...
                        <div className="box flex-col justify-start items-start">
                            ...
                            <p>
                                ...
                                - حيث أن منصات المشاهير تسعى للحفاظ على سلامة الصفحات الالكترونية والعلاقة التعاقدية بين حقوق التُجّار والمشاهير، فإنه – في حال ملاحظة منصات المشاهير لأي نشاط غير نظامي أو غير شرعي يقوم به التاجر او المشهور – فإنّ منصات المشاهير تقوم بتطبيق مواد وبنود وأحكام <span className=" underline cursor-pointer" onClick={() => {
                                    navigate("/home/term")
                                    goUpWindow();
                    ...
                    <div className="content min-h-[357px] w-full py-[43px] px-[30px] md:px-[58px] flex gap-[43px] flex-col justify-start items-start">
                        ...
                        <div className="box flex-col justify-start items-start">
                            ...
                            <p>
                                - تسعى منصات المشاهير إلى الحفاظ على سرية معلومات مستخدمين المنصات، وحيث أنّ سياسة الخصوصية الخاصة بالمستخدمين (التاجر، المتابع) أو المشاهير لن تخالف أحكام  <span className=" underline cursor-pointer" onClick={() => { navigate("/home/term"); goUpWindow() }}>اتفاقية الاستخدام</span> أو سياسة الخصوصية وسرية المعلومات. ولكن نظراً لعدم إمكانية ضمان ذلك 100% في (فضاء الإنترنت) فإنّ فريق عمل منصات المشاهير، ينوّه على يلي:
